...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		function _set_interface() {
			...
			$('body').append('<div id="jquery-overlay"></div><div id="jquery-lightbox"><div id="lightbox-container-image-box"><div id="lightbox-container-image"><img id="lightbox-image"><div style="" id="lightbox-nav"><a href="#" id="lightbox-nav-btnPrev"></a><a href="#" id="lightbox-nav-btnNext"></a></div><div id="lightbox-loading"><a href="#" id="lightbox-loading-link"><img src="' + settings.imageLoading + '"></a></div></div></div><div id="lightbox-container-image-data-box"><div id="lightbox-container-image-data"><div id="lightbox-image-details"><div id="lightbox_picinfo"><p><span class="lightbox_label">Name:</span><span id="lightbox_picname" class="lightbox_picdata"></span></p><p><span class="lightbox_label">Description:</span><span id="lightbox_picdesc" class="lightbox_picdata"></span></p><p><span class="lightbox_label">Owner:</span><span id="lightbox_picowner" class="lightbox_picdata"></span></p></div><span id="lightbox-image-details-caption"></span><span id="lightbox-image-details-currentNumber"></span></div><div id="lightbox-secNav"><a href="#" id="lightbox-secNav-btnClose"><img src="' + settings.imageBtnClose + '"></a></div></div></div></div>');	
			// Get page sizes
		...
		function _resize_container_image_box(intImageWidth,intImageHeight) {
			// Get current width and height
                    if (intImageWidth > 960) {
            	        var scale = intImageWidth / 960;
            	        intImageWidth = 960;
